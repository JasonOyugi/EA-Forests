...
const companies = [
  { name: "KNH", src: "/KNH.png" },
  { name: "Aga Khan", src: "/AgaKhan.png" },
  { name: "WHO", src: "/WHO.png" },
  { name: "KEMSA", src: "/KEMSA.png" },
  { name: "Nairobi Hospital", src: "/NairobiHospital.png" },
  { name: "ACM", src: "/ACM.png" },
  { name: "MP Shah", src: "/MPShah.jpg" },
] as const
      ...
      <div className={landingContainer}>
        <ScrollReveal className="text-center" distance={18}>
          <p className={`${landingEyebrowClass} mb-8`}>
            Trusted by leading regional and global healthcare experts and practitioners
          </p>
