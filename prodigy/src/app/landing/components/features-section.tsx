...
import { BookOpen, HeartHandshake, LoaderCircle, ShoppingBag, Sparkles } from "lucide-react"
      ...
      <div className={landingContainer}>
        <ScrollReveal className={landingSectionIntro} distance={22}>
          ...
          <h2 className={landingHeadingClass}>
            Day-to-day personal and facility healthcare solutions
          </h2>
        </ScrollReveal>
          ...
          <ScrollReveal delay={180}>
            <BentoTilt className="h-full overflow-hidden rounded-xl border bg-card shadow-sm">
              <BentoCard
                ...
                image="/KNH.webp"
                title={<>Consultation</>}
                description="Talk to the Prodigy team about sourcing, personal care needs, and facility supply planning."
                href="#contact"
              />
            </BentoTilt>
          </ScrollReveal>
