...
export const landingLeadClass = "mx-auto max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg sm:leading-8"
export const landingEyebrowClass = "text-sm font-medium text-muted-foreground"
export const landingHeroHeadingClass =
  "mb-6 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl xl:text-6xl"
export const landingHeroLeadClass =
  "mx-auto mb-10 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg sm:leading-8 lg:text-xl"
