...
export function EnhancedProductCard({
  ...
  const featuredStyleCard = theme === "wellness-products" && compact
  const gridVariantShade = (variantId: string) => {
    if (theme !== "wellness-products") return "border-white/80 bg-transparent text-white hover:border-primary hover:bg-primary/10"
    if (variantId === "small") return "border-white bg-transparent text-white hover:border-emerald-400 hover:text-emerald-900 hover:shadow-[0_0_0_3px_rgba(61, 204, 196,0.18)]"
    if (variantId === "medium") return "border-white bg-transparent text-white hover:border-emerald-500 hover:text-emerald-950 hover:shadow-[0_0_0_3px_rgba(23, 179, 172,0.2)]"
    if (variantId === "large") return "border-white bg-transparent text-white hover:border-emerald-700 hover:text-emerald-950 hover:shadow-[0_0_0_3px_rgba(12, 118, 114,0.22)]"
    return "border-white bg-transparent text-white hover:border-emerald-500 hover:text-emerald-950 hover:shadow-[0_0_0_3px_rgba(23, 179, 172,0.2)]"
  }
  const gridVariantSelectedShade = (variantId: string) => {
    if (theme !== "wellness-products") return variantButtonSelected
    if (variantId === "small") return "border-emerald-500 bg-emerald-100 text-emerald-950 shadow-[0_0_0_3px_rgba(61, 204, 196,0.18)]"
    if (variantId === "medium") return "border-emerald-700 bg-emerald-300 text-emerald-950 shadow-[0_0_0_3px_rgba(23, 179, 172,0.2)]"
    if (variantId === "large") return "border-emerald-900 bg-emerald-600 text-white shadow-[0_0_0_3px_rgba(12, 118, 114,0.22)]"
  ...
  const startingUnitLabel =
    ...
    (startingVariant?.count ? `per ${startingVariant.count} units` : item.unitLabel)
  ...
  if (runningBorderOnHover) {
    const runningBorderClass =
      theme === "wellness-products"
        ? "emerald-border-hover hover:shadow-[0_0_28px_rgba(23, 179, 172,0.28)]"
