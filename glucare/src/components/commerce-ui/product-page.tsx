  ...
  return [
    {
      id: `${item.id}-retailer`,
      name: retailer.name,
      description: `${retailer.name} is the nearest available clinic currently shown for this listing.`,
      image: item.image,
      latitude: -1.2864,
      longitude: 36.8172,
      phone: "+254 700 000 000",
      email: "hello@glucare.health",
  ...
  return (
    <div className="theme-primary-border-hover rounded-[2rem] border border-transparent bg-transparent p-3 transition-shadow duration-300 hover:shadow-lg">
      <div className="space-y-2 px-1 pb-4">
        <CardTitle className="text-xl">{copy.panelTitle}</CardTitle>
        <p className="text-sm text-muted-foreground">
          Choose a contact option below to continue without loading a map.
        </p>
      </div>
    ...
    () => [
      {
        ...
        date: "2026-04-12",
        text:
          item.shop === "diabetes-programs"
            ? "The program structure was clear and the care team made it easy to stay on track."
      ...
      },
      {
        ...
        text:
          item.shop === "diabetes-programs"
            ? "Clear pricing and strong context around what the program actually involves."
            : item.shop === "hospital-services"
      ...
      },
      {
        ...
        text:
          item.shop === "diabetes-programs"
            ? "Useful for getting from a shortlist to actually starting the program quickly."
            : item.shop === "hospital-services"
