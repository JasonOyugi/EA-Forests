...
export function CommandSearch({ open, onOpenChange }: CommandSearchProps) {
  ...
  const searchItems: SearchItem[] = [
    { title: "Landing Page", url: "/landing", group: "Pages", icon: Home },
    { title: "Diabetes Care", url: "/shop/diabetes-programs", group: "Care", icon: Stethoscope },
    { title: "Booking Calendar", url: "/calendar", group: "Care", icon: Calendar },
    { title: "Health Tools", url: "/models", group: "Health Tools", icon: Activity },
    { title: "BMI Calculator", url: "/models/bmi-calculator", group: "Health Tools", icon: Activity },
    { title: "Diabetes Risk Assessment", url: "/models/diabetes-risk-assessment", group: "Health Tools", icon: HeartPulse },
    { title: "3D Vitality Explorer", url: "/models/vitality-3d", group: "Health Tools", icon: Atom },
  ]
