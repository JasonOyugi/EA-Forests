...
const faqItems: FaqItem[] = [
  {
    value: 'item-1',
    question: 'What is GluCare?',
    answer:
      'GluCare is a focused diabetes care experience for remission-focused programs, consultation booking, practical health tools, and care information.',
  },
  {
    value: 'item-2',
    question: 'What diabetes programs are available?',
    answer:
      'Browse Diabetes Care for structured remission, management, nutrition, and monitoring programs.',
  },
  {
    value: 'item-3',
  ...
  {
    value: 'item-4',
    question: 'Do you offer self-serve health tools?',
    answer:
      'Yes. The Health Tools section includes BMI, diabetes risk assessment, and a 3D vitality explorer.',
  },
  {
    value: 'item-5',
    question: 'How do I book a consultation?',
    answer:
      'Use the booking calendar or the contact section to schedule consultation time with the GluCare team.',
  },
]
      ...
      <div className={landingContainer}>
        ...
        <ScrollReveal className={landingSectionIntro} distance={22}>
          ...
          <p className={landingLeadClass}>
            What people are asking about GluCare programs and consultations:
          </p>
        </ScrollReveal>
