...
import { BookOpen, HeartPulse, LoaderCircle, Sparkles, Stethoscope } from "lucide-react"
      ...
      <div className={landingContainer}>
        <ScrollReveal className={landingSectionIntro} distance={22}>
          ...
          <h2 className={landingHeadingClass}>
            Focused diabetes care for everyday decisions
          </h2>
        </ScrollReveal>
        ...
        <ScrollReveal className="mb-7" delay={80}>
          <BentoTilt className="relative h-full w-full overflow-hidden rounded-xl border bg-card shadow-sm md:h-[50vh]">
            <BentoCard
              ...
              description="Specialized diabetes care, practical tools, and consultation support in one place."
              href="#about"
            />
          </BentoTilt>
        </ScrollReveal>
          ...
          <ScrollReveal className="h-full md:row-span-2" delay={120}>
            <BentoTilt className="h-full overflow-hidden rounded-xl border bg-card shadow-sm">
              <BentoCard
                ...
                video="/feature-1.mp4"
                title={<>Programs</>}
                description="Structured diabetes remission, management, nutrition, and monitoring programs."
          ...
          <ScrollReveal delay={180}>
            <BentoTilt className="h-full overflow-hidden rounded-xl border bg-card shadow-sm">
              <BentoCard
                ...
                video="/hospital.mp4"
                title={<>Consultation</>}
                description="Book consultation time for diabetes care planning and program guidance."
                href="/calendar"
              />
            </BentoTilt>
          </ScrollReveal>
