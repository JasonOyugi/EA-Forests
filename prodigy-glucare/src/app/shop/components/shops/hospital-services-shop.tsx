  ...
  return (
    <section aria-labelledby="hospital-category-heading" className="space-y-4">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-sm font-semibold uppercase tracking-wider text-sky-700">Hospital categories</p>
          <h2 id="hospital-category-heading" className="text-2xl font-bold tracking-tight text-slate-950">
            Shop supplies by department need
          </h2>
        </div>
        <a
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {hospitalCategoryBanners.map((category) => {
          ...
          return (
            ...
            >
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.32),transparent_34%)]" />
    ...
    <ShopCommonLayout
      ...
      banner={
        <ShopPromoBanner
          ...
          title="Hospital & Dialysis Supplies, Delivered Reliably"
          description="Dialysis consumables, high-level disinfectants, vascular access devices, and wound care supplies from Prodigy Hospital."
      ...
      featuredSubtitle="Popular dialysis consumables and disinfectants"
      featuredTheme="hospital-services"
      featuredSectionClassName="rounded-xl"
      newItems={newItems}
      newTitle="New Arrivals"
      newSubtitle="Latest hospital and dialysis supplies now available"
