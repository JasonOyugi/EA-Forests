...
import { ArrowRight, HeartPulse, ShoppingBag, Users } from 'lucide-react'
            ...
            <div className='space-y-8'>
              ...
              <div className='flex flex-col items-center gap-4'>
                <Badge variant='outline' className="badge-emerald-run text-primary rounded-lg px-4 py-2 
                          ...
                          shadow-[0_0_22px_rgba(23, 179, 172,0.35)]">
                ...
                <div className='text-muted-foreground flex items-center gap-4 text-sm'>
                  <span className='flex items-center gap-1'>
                    ...
                    Remission-focused programs
                  </span>
                  <Separator orientation='vertical' className='!h-4' />
                  <span>Wellness + Hospital care</span>
                  <Separator orientation='vertical' className='!h-4' />
              ...
              <div className='space-y-6'>
                <h1 className='text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl xl:text-6xl'>
                  ...
                  <span className="emerald-glitter-text bg-gradient-to-r from-emerald-300 via-emerald-500 to-emerald-200 bg-clip-text text-transparent">
                    Healthier, Well-Managed Lives
                  </span>
                </h1>

                <p className={landingLeadClass}>
                  From everyday wellness products to hospital care and specialist diabetes remission programs,
                  we bring the care you need to you, book a consultation and start your journey today.
                </p>
              </div>
              ...
              <div className='flex flex-col justify-center gap-4 sm:flex-row sm:gap-6'>
                ...
                <Button variant="outline" size="lg" className="px-8 py-6 emerald-border-hover text-base cursor-pointer transition-all duration-300 hover:text-emerald-400 hover:bg-secondary/20 hover:shadow-[0_0_24px_rgba(23, 179, 172,0.35)]" asChild>
                  <a href={getAppUrl('/shop/wellness-products')}>
              ...
              <div className='text-muted-foreground flex flex-wrap items-center justify-center gap-6 text-sm'>
                <div className='flex items-center gap-2'>
                  ...
                  <span>Free health information available</span>
                </div>
                <div className='flex items-center gap-2'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <span>Ongoing monitoring & support</span>
                </div>
              </div>
            </div>
          </ScrollReveal>
