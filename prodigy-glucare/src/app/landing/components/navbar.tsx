...
const shopToggleItems = [
  { name: "Wellness Store", href: getAppUrl("/shop/wellness-products") },
  { name: "Hospital Services", href: getAppUrl("/shop/hospital-services") },
  { name: "Diabetes Programs", href: getAppUrl("/shop/diabetes-programs") },
] as const
    ...
    <header className="landing-navbar sticky top-0 z-50 w-full overflow-hidden border-b border-transparent bg-transparent backdrop-blur-xl">
      ...
      <div className="container relative z-10 mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            <Logo size={32} />
            <span className="font-bold">Prodigy | GluCare</span>
          </a>
        </div>
        ...
        <div className="hidden xl:flex items-center space-x-2">
          ...
          <Button 
            ...
            className="emerald-border-hover text-base cursor-pointer
                      ...
                      hover:shadow-[0_0_24px_rgba(23, 179, 172,0.35)]">
            ...
            <div className="flex flex-col h-full">
              ...
              <SheetHeader className="space-y-0 p-4 pb-2 border-b">
                <div className="flex items-center gap-2">
                  ...
                  <SheetTitle className="text-sm">Prodigy GluCare</SheetTitle>
              ...
              <div className="border-t p-6 space-y-4">
                <div className="space-y-3">
                  <Button variant="outline" size="lg" asChild className="emerald-border-hover text-base cursor-pointer w-full transition-all duration-300 hover:text-emerald-400 hover:shadow-[0_0_24px_rgba(23, 179, 172,0.35)]">
