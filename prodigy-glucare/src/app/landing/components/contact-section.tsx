...
export function ContactSection() {
  ...
  return (
    <section id="contact" className={landingSectionPadding}>
      <div className={landingContainer}>
        <div className={landingSectionIntro}>
          <Badge variant="outline" className={landingBadgeClass}>Get In Touch</Badge>
          <h2 className={landingHeadingClass}>
            Need help or have questions?
          </h2>
          <p className={landingLeadClass}>
            Our team is here to help you get the most out of Prodigy GluCare. Choose the best way to reach out to us.
          </p>
        </div>
        ...
        <div className="grid gap-4 sm:gap-6 md:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="space-y-4 sm:space-y-6 order-2 lg:order-1">
            <Card className="hover:shadow-md bg-primary/25 transition-shadow cursor-pointer">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-3">
                  Speak directly with our care team to book a consultation or ask about wellness products.
                </p>
            ...
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-3">
                  Browse our health information library for practical guidance on diabetes and wellness.
                </p>
                <Button variant="outline" size="sm" className="cursor-pointer" asChild>
                  <a href="#blog">
                    View Health Library
