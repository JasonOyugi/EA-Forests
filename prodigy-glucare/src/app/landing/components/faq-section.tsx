...
const faqItems: FaqItem[] = [
  {
    value: 'item-1',
    question: 'What is Prodigy GluCare?',
    answer:
      'Prodigy GluCare brings together Prodigy Healthcare\'s wellness products and hospital services with GluCare\'s specialized, remission-focused diabetes care, in one connected experience.',
  },
  {
    value: 'item-2',
    question: 'Can I order wellness products online?',
    answer:
      'Yes. Browse the wellness store for supplements, skincare, and weight-management products, and check out directly from the shop.',
  },
  {
    value: 'item-3',
    question: 'How does the diabetes remission program work?',
    answer:
      'Our care team reviews your history and current metrics, then builds a structured plan combining nutrition and lifestyle therapy, personalised diabetes management, and remote monitoring where appropriate.',
  },
  {
    value: 'item-4',
    question: 'Do you offer hospital services beyond diabetes care?',
    answer:
      'Yes. Prodigy Hospital Supplies covers dialysis consumables, high-level disinfectants, vascular access devices, and wound care supplies, alongside the wellness store and diabetes programs.',
  },
  {
    value: 'item-5',
    question: 'How do I book a consultation?',
    answer:
      'Use the "Book a Diabetes Consultation" or "Talk to our team" buttons on this page, or reach out directly through the contact section below.',
  },
]
      ...
      <div className={landingContainer}>
        ...
        <ScrollReveal className={landingSectionIntro} distance={22}>
          ...
          <p className={landingLeadClass}>
            What people are asking about Prodigy GluCare's services and programs:
          </p>
        </ScrollReveal>
