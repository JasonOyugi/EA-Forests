...
export function CommandSearch({ open, onOpenChange }: CommandSearchProps) {
  ...
  const searchItems: SearchItem[] = [
    ...
    // Models
    { title: "Models", url: "/models", group: "Models", icon: Activity },
    { title: "BMI Calculator", url: "/models/bmi-calculator", group: "Models", icon: Activity },
    { title: "Diabetes Risk Assessment", url: "/models/diabetes-risk-assessment", group: "Models", icon: HeartPulse },
    { title: "3D Vitality Explorer", url: "/models/vitality-3d", group: "Models", icon: Atom },
