...
function getCommerceCopy(shop: ShopItem["shop"]) {
  ...
  if (shop === "hospital-services") {
    return {
      panelTitle: "Nearest care team",
      panelDescription:
        "Choose a marker to inspect the nearest hospital care team, review contact details, and book with that team in mind.",
      popupEyebrow: "Hospital care team",
      selectedBadge: "Selected care team",
